...
[![Server](https://img.shields.io/badge/beear-0.4.5-0E8A16.svg)](packages/server/pyproject.toml)
...
| **Glasses GLBs** | **Meshy square** + Meshy studio + aviator, wayfarer, round, cat-eye, sport, … |
